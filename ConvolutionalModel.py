...
class CNN(NeuralNetwork):
    ...
    def initialize_model(self):
        ...
        self.model.add(keras.layers.Conv2D(32, (11, 11), strides=(3, 3)))
        self.model.add(keras.layers.Activation('relu'))
        self.model.add(keras.layers.MaxPool2D((2, 2), strides=(2, 2)))

        self.model.add(keras.layers.Conv2D(128, (3, 3), strides=(1, 1), padding='same'))
        self.model.add(keras.layers.Activation('relu'))
        self.model.add(keras.layers.MaxPool2D((3, 3), strides=(2, 2)))
